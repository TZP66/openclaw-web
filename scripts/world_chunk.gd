...
func _draw_foundry_channels() -> void:
	...
	for row in range(4):
		...
		draw_rect(Rect2(Vector2(0.0, y - 30.0), Vector2(chunk_size.x, 60.0)), Color(line_color.r, line_color.g, line_color.b, 0.20))
		draw_rect(Rect2(Vector2(0.0, y - 16.0), Vector2(chunk_size.x, 32.0)), Color(rune_color.r, rune_color.g, rune_color.b, 0.46))
	for column in range(3):
		var x := 260.0 + float(column) * 420.0 + rng.randf_range(-24.0, 24.0)
		draw_rect(Rect2(Vector2(x - 26.0, 0.0), Vector2(52.0, chunk_size.y)), Color(0.26, 0.10, 0.08, 0.42))
...
func _build_sky_specs(rng: RandomNumberGenerator, colors: Dictionary) -> Array[Dictionary]:
	...
	match layout:
		0:
			specs = [
				_make_obstacle_spec(Vector2(280.0, 280.0), Vector2(140.0, 250.0), "pillar", colors),
				_make_obstacle_spec(Vector2(760.0, 360.0), Vector2(420.0, 74.0), "bridge", colors),
				_make_obstacle_spec(Vector2(1210.0, 300.0), Vector2(140.0, 220.0), "pillar", colors),
		...
		1:
			specs = [
				...
				_make_obstacle_spec(Vector2(780.0, 760.0), Vector2(180.0, 240.0), "altar", colors),
				_make_obstacle_spec(Vector2(260.0, 1180.0), Vector2(130.0, 230.0), "pillar", colors),
				_make_obstacle_spec(Vector2(1300.0, 1120.0), Vector2(130.0, 260.0), "pillar", colors),
			]
		_:
			specs = [
				_make_obstacle_spec(Vector2(300.0, 300.0), Vector2(120.0, 220.0), "pillar", colors),
				_make_obstacle_spec(Vector2(1260.0, 360.0), Vector2(120.0, 220.0), "pillar", colors),
	...
	match layout:
		0:
			specs = [
				...
				_make_obstacle_spec(Vector2(820.0, 760.0), Vector2(118.0, 280.0), "pillar", colors),
		...
		1:
			specs = [
				_make_obstacle_spec(Vector2(280.0, 360.0), Vector2(160.0, 280.0), "pillar", colors),
				_make_obstacle_spec(Vector2(790.0, 300.0), Vector2(420.0, 86.0), "forge_wall", colors),
				_make_obstacle_spec(Vector2(1300.0, 340.0), Vector2(160.0, 280.0), "pillar", colors),
		...
		_:
			specs = [
				...
				_make_obstacle_spec(Vector2(300.0, 780.0), Vector2(180.0, 300.0), "pillar", colors),
				_make_obstacle_spec(Vector2(1280.0, 780.0), Vector2(180.0, 300.0), "pillar", colors),
	...
	match layout:
		0:
			specs = [
				...
				_make_obstacle_spec(Vector2(760.0, 760.0), Vector2(170.0, 260.0), "pillar", colors),
		...
		1:
			specs = [
				_make_obstacle_spec(Vector2(270.0, 360.0), Vector2(120.0, 230.0), "pillar", colors),
				_make_obstacle_spec(Vector2(780.0, 340.0), Vector2(360.0, 82.0), "reed_bank", colors),
				_make_obstacle_spec(Vector2(1310.0, 360.0), Vector2(120.0, 230.0), "pillar", colors),
		...
		_:
			specs = [
				...
				_make_obstacle_spec(Vector2(320.0, 820.0), Vector2(140.0, 260.0), "pillar", colors),
				_make_obstacle_spec(Vector2(1240.0, 860.0), Vector2(140.0, 260.0), "pillar", colors),
